document.addEventListener("DOMContentLoaded", () => {
    ...
    function hideAllSections() {
      ...
      buttons.forEach((button) => {
        button.style.backgroundColor = "#333"; // Reset to light blue
    ...
    function styleButton(button) {
      button.style.backgroundColor = "#808080"; // Light blue background
    ...
    function createButton(button, label, section) {
      ...
      button.addEventListener("click", () => {
        ...
        button.style.backgroundColor = "#808080"; // White background when active
